...
@section('content')
  ...
  <div class="content-header pb-1">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h4 class="m-0 text-dark">Upload Assignment</h4>
        </div><!-- /.col -->
        <div class="col-sm-6">
  ...
  <section class="content">
    ...
    <form method="POST" action="{{ route('uploadassignment.store') }}" enctype="multipart/form-data">
        @csrf
        ...
        <div class="ml-4 mr-4">
            ...
            <option value = "{{$detail->department_id}},{{$detail->subject_id}},{{$detail->semester_id}},{{$detail->section_id}},{{Auth::user()->user_id}}"> 
       ...
       $('.dynamic').change(function(){
        ...
        var a = value.split(",");
         ...
         $.ajax({
          ...
          method:"GET",
          data:{_token:_token, dependent:dependent,department_id:a[0],subject_id:a[1],section_id:a[3]},
