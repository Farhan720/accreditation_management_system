...
@section('content')
  ...
  <div class="content-header pb-1">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h4 class="m-0 text-dark">View Quiz</h4>
        </div><!-- /.col -->
        <div class="col-sm-6">
  ...
  <section class="content">
            ...
            Select Subject
            <select class="form-control select2 dynamic1" name="assignment_detail" id="subject_id" data-dependent="quiz_number" required>
            ...
            <div class="form-group mt-2 ">
              ...
              name="quiz_number" id="quiz_number" data-dependent="quiz"  required>
      ...
      $(document).ready(function(){
       ...
       $('.dynamic2').change(function(){
        ...
        var quiz_number = $('#quiz_number').val();
         ...
         $.ajax({
          url:"{{ route('quizanswer.index') }}",
          method:"GET",
          data:{_token:_token,subject_id:a[2],semester_id:a[3],section_id:a[4],quiz_number:quiz_number},
